...
public class Database {
   ...
   protected static final String URL = "jdbc:mysql://localhost/siomassy2022?noAccessToProcedureBodies=true";
   protected static final String USER = "siomassy2022_user";
   protected static final String PASSWORD = "siomassy2022_pwd";
    ...
    * stockée siomassy2022_reset().
    * @throws SQLException 
    */
   public static void reset(LocalDateTime dateEffet) throws SQLException {
      Connection connection = Database.getConnection();
      CallableStatement stmt = connection.prepareCall("CALL reset_siomassy2022(?)");
