 ...
 * @author ak
 */
@WebServlet(name = "controleurAfficheEfg", urlPatterns = {"/ResultatBon"})
public class controleurAfficheEfg extends HttpServlet {
 private final static String VUE = "/WEB-INF/ResultatBon.jsp";
